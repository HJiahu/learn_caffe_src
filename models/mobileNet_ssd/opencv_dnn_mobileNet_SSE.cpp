...
int main (int argc, char** argv)
{
    ...
    String modelConfiguration{ R"(E:\CNN_Models\SSD\MobileNetSSD\MobileNetSSD_deploy000.prototxt)" };
    String modelBinary{ R"(E:\CNN_Models\SSD\MobileNetSSD\MobileNetSSD_deploy.caffemodel)" };
    //! [Initialize network]
